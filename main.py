...
def is_resource_sufficient(order_ingredients):
    ''':Returns True if the order can be made or returns False if the order can't be made'''
...
while is_on:
    ...
    if choice == "off":
        ...
        if is_resource_sufficient(drink['ingredients']):
            ...
            if is_transuction_successful(payment, drink["cost"]):
